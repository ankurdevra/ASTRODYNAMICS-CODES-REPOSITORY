function [Position_GCRF,Velocity_GCRF] = IAU2006_2000_CIOBasedReduction_ITRFtoGCRF(Position_ITRF,Velocity_ITRF,Year_Month_Day,Coordinated_Universal_Time,Delta_Universal_Time_1,Delta_Atomic_Time,...
...
% to Geocentric Celestial Reference Frame (GCRF) from International
% Terrestrial Reference Frame (ITRF). The algorithm is based on IAU-2006/2000, CIO based reduction. 
...
format long;
%% Inputs
r_ITRF_vec = Position_ITRF; % [1x3], [km], Vector of ITRF x,y,z positions
v_ITRF_vec = Velocity_ITRF; % [1x3], [km/sec], Vector of ITRF vx,vy,vz velocities
...
r_TIRS_vec = (W_ITRFtoTIRS*r_ITRF_vec')'; % [1x3], [km], Vector of TIRS x,y,z positions
v_TIRS_vec = (W_ITRFtoTIRS*v_ITRF_vec')'; % [1x3], [km/sec], Vector of TIRS vx,vy,vz velocities
...
r_CIRS_vec = (W_TIRStoCIRS*r_TIRS_vec')'; % [1x3], [km], Vector of CIRS x,y,z positions
v_CIRS_vec = (W_TIRStoCIRS*(v_TIRS_vec+cross([0,0,omega_Earth],r_TIRS_vec))')'; % [1x3], [km/sec], Vector of CIRS vx,vy,vz velocities
...
r_GCRF_vec = (PN_Matrix_CIRStoGCRF*r_CIRS_vec')'; % [1x3], [km], Vector of GCRF x,y,z positions
v_GCRF_vec = (PN_Matrix_CIRStoGCRF*v_CIRS_vec')'; % [1x3], [km/sec], Vector of GCRF vx,vy,vz velocities
%% Outputs
Position_GCRF=r_GCRF_vec; % [1x3], [km], Vector of GCRF x,y,z positions
Velocity_GCRF=v_GCRF_vec; % [1x3], [km/sec], Vector of ITRF vx,vy,vz velocities
end